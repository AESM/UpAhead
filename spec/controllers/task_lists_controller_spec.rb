...
RSpec.describe TaskListsController, type: :controller do
  ...
  let(:valid_attributes) { { "title" => "My String", "description" => "My description" } }
  ...
  describe "GET #new" do
    it "assigns a new task_list as @task_list" do
      ...
      expect(assigns(:task_list)).to be_a_new(TaskList)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created task_list as @task_list" do
        post :create, {:task_list => valid_attributes}, valid_session
        expect(assigns(:task_list)).to be_a(TaskList)
        expect(assigns(:task_list)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved task_list as @task_list" do
        post :create, {:task_list => invalid_attributes}, valid_session
        expect(assigns(:task_list)).to be_a_new(TaskList)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the task_list" do
        task_list = TaskList.create! valid_attributes
        put :update, {:id => task_list.to_param, :task_list => valid_attributes}, valid_session
        expect(response).to redirect_to(task_list)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the task_list as @task_list" do
        task_list = TaskList.create! valid_attributes
        put :update, {:id => task_list.to_param, :task_list => invalid_attributes}, valid_session
        expect(assigns(:task_list)).to eq(task_list)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the task_lists list" do
      task_list = TaskList.create! valid_attributes
      delete :destroy, {:id => task_list.to_param}, valid_session
      expect(response).to redirect_to(task_lists_url)
    end
  end
